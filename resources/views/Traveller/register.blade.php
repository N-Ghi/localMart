...
<head>
    ...
    <title>Traveller Register</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>

    <div class="container mt-5">
        <h1 class="text-center mb-4">Traveller Register</h1>
        <form action="{{route('storeTraveller')}}" method="POST" class="mx-auto p-4 shadow-lg rounded" style="max-width: 500px; background-color: #f9f9f9;">
            @csrf
            <div class="form-group">
                <label for="name">Traveller Names</label>
