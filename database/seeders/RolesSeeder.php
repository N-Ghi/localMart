...
class RolesSeeder extends Seeder
{
    ...
    public function run()
    {
        $roles = [
            ...
            'traveller' => ['view-booking', 'create-booking', 'edit-booking', 'delete-booking', 'view-service', 'view-payment', 'create-payment', 'edit-payment', 'delete-payment', 'create-profile', 'edit-profile', 'delete-profile', 'view-profile', 'create-booking', 'view-booking'],
        ];
